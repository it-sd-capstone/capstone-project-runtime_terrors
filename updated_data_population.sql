...
DELIMITER //
CREATE FUNCTION IF NOT EXISTS generate_phone() 
RETURNS VARCHAR(20)
DETERMINISTIC
BEGIN
...
-- ========== PROVIDER USERS GENERATION ==========
INSERT INTO users (email, password_hash, first_name, last_name, phone, role, is_active, is_verified, email_verified_at, created_at)
VALUES
('provider@example.com', @provider_password, 'Jennifer', 'Smith', generate_phone(), 'provider', 1, 1, @current_datetime, @current_datetime),
('provider2@example.com', @provider_password, 'Michael', 'Johnson', generate_phone(), 'provider', 1, 1, @current_datetime, @current_datetime),
('provider3@example.com', @provider_password, 'David', 'Williams', generate_phone(), 'provider', 1, 1, @current_datetime, @current_datetime),
('provider4@example.com', @provider_password, 'Sarah', 'Brown', generate_phone(), 'provider', 1, 1, @current_datetime, @current_datetime),
('provider5@example.com', @provider_password, 'James', 'Davis', generate_phone(), 'provider', 1, 1, @current_datetime, @current_datetime),
('provider6@example.com', @provider_password, 'Emily', 'Miller', generate_phone(), 'provider', 1, 1, @current_datetime, @current_datetime);

-- Save provider IDs for later use
...
-- ========== PATIENT USERS GENERATION ==========
INSERT INTO users (email, password_hash, first_name, last_name, phone, role, is_active, is_verified, email_verified_at, created_at)
VALUES
('patient@example.com', @patient_password, 'Robert', 'Anderson', generate_phone(), 'patient', 1, 1, @current_datetime, @current_datetime),
('patient2@example.com', @patient_password, 'Lisa', 'Taylor', generate_phone(), 'patient', 1, 1, @current_datetime, @current_datetime),
('patient3@example.com', @patient_password, 'Thomas', 'Moore', generate_phone(), 'patient', 1, 1, @current_datetime, @current_datetime),
('patient4@example.com', @patient_password, 'Jessica', 'Jackson', generate_phone(), 'patient', 1, 1, @current_datetime, @current_datetime),
('patient5@example.com', @patient_password, 'Daniel', 'White', generate_phone(), 'patient', 1, 1, @current_datetime, @current_datetime),
('patient6@example.com', @patient_password, 'Michelle', 'Harris', generate_phone(), 'patient', 1, 1, @current_datetime, @current_datetime),
('patient7@example.com', @patient_password, 'Kevin', 'Martin', generate_phone(), 'patient', 1, 1, @current_datetime, @current_datetime),
('patient8@example.com', @patient_password, 'Patricia', 'Thompson', generate_phone(), 'patient', 1, 1, @current_datetime, @current_datetime),
('patient9@example.com', @patient_password, 'Christopher', 'Garcia', generate_phone(), 'patient', 1, 1, @current_datetime, @current_datetime),
('patient10@example.com', @patient_password, 'Amanda', 'Martinez', generate_phone(), 'patient', 1, 1, @current_datetime, @current_datetime);

-- Save patient IDs for later use
...
ORDER BY RAND()
LIMIT 10; -- Create 10 waitlist entries
