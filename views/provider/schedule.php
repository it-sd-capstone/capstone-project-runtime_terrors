            ...
            <div class="card shadow-sm bg-white">
                <div class="card-body py-2">
                    ...
                    <p class="text-muted mb-0">
                        ...
                        Use the calendar below to view and manage your availability. Click on a date to add availability, 
                        or use the controls in the "Actions" panel.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card shadow-sm h-100">
                <div class="card-header bg-secondary text-white">
                    <ul class="nav nav-tabs card-header-tabs" id="actionTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="add-tab" data-bs-toggle="tab" data-bs-target="#add-panel" 
                                    type="button" role="tab" aria-selected="true">
                                <i class="fas fa-plus-circle"></i> Add
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="recurring-tab" data-bs-toggle="tab" data-bs-target="#recurring-panel" 
                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="add-panel" role="tabpanel" aria-labelledby="add-tab">
                            <h6 class="card-title"><i class="fas fa-clock me-1"></i> Add Availability</h6>
                        ...
                        <div class="tab-pane fade" id="recurring-panel" role="tabpanel" aria-labelledby="recurring-tab">
                        ...
                        <div class="tab-pane fade" id="manage-panel" role="tabpanel" aria-labelledby="manage-tab">
                            ...
                            <div class="card bg-light mb-3">
                                <div class="card-body py-2">
                                    ...
                                    <p class="card-text small mb-2">Create bookable slots based on your schedule.</p>
                                    <div class="row mb-2 g-2">
                                        <div class="col-6">
                                            <label class="form-label small fw-bold mb-0">Duration:</label>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('generateSlotsBtn')?.addEventListener('click', function() {
        ...
        fetch('<?= base_url('index.php/provider/generateAvailabilityFromSchedule') ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-Requested-With': 'XMLHttpRequest'
        ...
        .then(data => {
            if (data.success) {
                showNotification(data.message || `Successfully generated ${data.count || 0} availability slots`, 'success');
                calendar.refetchEvents();
            } else {
                showNotification(data.message || 'Failed to generate availability slots', 'danger');
            }
        ...
        .catch(error => {
            console.error('Error:', error);
            showNotification('Error generating availability slots', 'danger');
