...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="<?= base_url('index.php/admin/appointments/update/' . $appointment['appointment_id']) ?>" method="post">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="time" class="form-control" id="appointment_time" name="appointment_time" value="<?= $appointment['start_time'] ?>" required>
                    </div>
                </div>
